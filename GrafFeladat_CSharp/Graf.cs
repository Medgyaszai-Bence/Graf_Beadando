...
namespace GrafFeladat_CSharp
{
    ...
    class Graf
    {
        ...
        public void GrafSzelessegiBejar(int kezdopont) {
        ...
        public Dictionary<int, int> GrafMohoSzinezes() {
            ...
            int aktualisCsucs = 0;
            while (aktualisCsucs = 0 && this.csucsokSzama - 1)
            {
                var valaszthatoSzinek = new HashSet<int>(0, maxSzin - 1);
                ...
                var valasztottSzin = Math.Min(valaszthatoSzinek);
